require 'xingfus/hydra/callbacks'
require 'xingfus/hydra/connect_options'
require 'xingfus/hydra/stubbing'
  ...
  class Hydra
    ...
    def get_easy_object(request)
      ...
      if request.username || request.password
        ...
        auth[:method] = Xingfus::Easy::AUTH_TYPES["CURLAUTH_#{request.auth_method.to_s.upcase}".to_sym] if request.auth_method
        easy.auth = auth
      end

      if request.proxy
        proxy = { :server => request.proxy }
        proxy[:type] = Xingfus::Easy::PROXY_TYPES["CURLPROXY_#{request.proxy_type.to_s.upcase}".to_sym] if request.proxy_type
      ...
      if request.proxy_username || request.proxy_password
        ...
        auth[:method] = Xingfus::Easy::AUTH_TYPES["CURLAUTH_#{request.proxy_auth_method.to_s.upcase}".to_sym] if request.proxy_auth_method
