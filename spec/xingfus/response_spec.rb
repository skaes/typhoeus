...
describe Xingfus::Response do
  describe "timed_out?" do
    it "should return true if curl return code is 28" do
      response = Xingfus::Response.new(:curl_return_code => 28)
      response.should be_timed_out
    end

    it "should return false for not 28" do
      response = Xingfus::Response.new(:curl_return_code => 14)
  ...
  describe "#mock?" do
    it "should be true if it's a mock response" do
      response = Xingfus::Response.new(:mock => true)
  ...
  describe "status checking" do
    it "is successful if response code is 200-299" do
      Xingfus::Response.new(:code => 220).success?.should be
      Xingfus::Response.new(:code => 400).success?.should_not be
    end

    it "is not modified if the status code is 304" do
      Xingfus::Response.new(:code => 304).modified?.should_not be
      Xingfus::Response.new(:code => 200).modified?.should be
    end
  end
end
