  ...
  class Hydra
    ...
    module ConnectOptions
      ...
      def check_allow_net_connect!(request)
        return if Xingfus::Hydra.allow_net_connect?
        return if Xingfus::Hydra.ignore_hosts.include?(request.host_domain)
      ...
      module ClassMethods
        ...
        def ignore_hosts
          ...
          if ignore_localhost?
            @ignore_hosts + Xingfus::Request::LOCALHOST_ALIASES
          else
            @ignore_hosts
          end
        end
