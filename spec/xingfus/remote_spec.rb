...
describe Xingfus do
  ...
  #         }.should raise_error(Xingfus::MockExpectedError)
  #       end
  #     end
  #   end
  # 
  ...
  #     lambda {
  #       @klass.get("http://stuff", :params => { :a => 'test' })
  #     }.should_not raise_error(Xingfus::MockExpectedError)
  #   end
  #   
  ...
  #     end
  # 
  #     it "should allow for subclassing a class that includes Xingfus, and merging defaults" do
  #       class TestA
  #         include Xingfus
