...
describe Xingfus::RemoteMethod do
  it "should take options" do
    Xingfus::RemoteMethod.new(:body => "foo")
  end
  
  describe "http_method" do
    it "should return the http method" do
      m = Xingfus::RemoteMethod.new(:method => :put)
      m.http_method.should == :put
    end
    
    it "should default to :get" do
      m = Xingfus::RemoteMethod.new
      m.http_method.should == :get
    end
  end
  
  it "should return the options" do
    m = Xingfus::RemoteMethod.new(:body => "foo")
    m.options.should == {:body => "foo"}
  end
  
  it "should pull uri out of the options hash" do
    m = Xingfus::RemoteMethod.new(:base_uri => "http://pauldix.net")
  ...
  describe "on_success" do
    it "should return the block" do
      m = Xingfus::RemoteMethod.new(:on_success => lambda {:foo})
  ...
  describe "on_failure" do
    it "should return method name" do
      m = Xingfus::RemoteMethod.new(:on_failure => lambda {:bar})
  ...
  describe "path" do
    ...
    it "should provide the path when interpolated called and there is nothing to interpolate" do
      m = Xingfus::RemoteMethod.new(:path => "/posts/123")
  ...
  describe "memoize_reponses" do
    before(:each) do
      @m = Xingfus::RemoteMethod.new(:memoize_responses => true)
      @args    = ["foo", "bar"]
  ...
  describe "cache_reponses" do
    before(:each) do
      @m = Xingfus::RemoteMethod.new(:cache_responses => true)
      @args    = ["foo", "bar"]
      @options = {:asdf => {:jkl => :bar}}
    end
    ...
    it "should store cache ttl" do
      Xingfus::RemoteMethod.new(:cache_responses => 30).cache_ttl.should == 30
    end
  end
end
